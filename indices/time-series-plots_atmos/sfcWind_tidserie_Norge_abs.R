...
### Filelists
# near future
filelist_wind_rcp26_nf <- list.files("/lustre/storeB/project/KSS/kin2100_2024/Indices/30yr-diff-files_for_plotting/sfcWind/","30yrmean_nf-diff.*rcp26",full.names = T)
filelist_wind_rcp45_nf <- list.files("/lustre/storeB/project/KSS/kin2100_2024/Indices/30yr-diff-files_for_plotting/sfcWind/","30yrmean_nf-diff.*rcp45",full.names = T)
filelist_wind_ssp370_nf <- list.files("/lustre/storeB/project/KSS/kin2100_2024/Indices/30yr-diff-files_for_plotting/sfcWind/","30yrmean_nf-diff.*ssp370",full.names = T)

# far future
filelist_wind_rcp26_ff <- list.files("/lustre/storeB/project/KSS/kin2100_2024/Indices/30yr-diff-files_for_plotting/sfcWind/","30yrmean_ff-diff.*rcp26",full.names = T)
filelist_wind_rcp45_ff <- list.files("/lustre/storeB/project/KSS/kin2100_2024/Indices/30yr-diff-files_for_plotting/sfcWind/","30yrmean_ff-diff.*rcp45",full.names = T)
filelist_wind_ssp370_ff <- list.files("/lustre/storeB/project/KSS/kin2100_2024/Indices/30yr-diff-files_for_plotting/sfcWind/","30yrmean_ff-diff.*ssp370",full.names = T)
...
png("/home/andreasd/Documents/KiN2100_2023/Indices/plots/sfcWind/sfcWind_diffs_ANN.png",width = k*1280, height = k*640,pointsize=k*28)
...
plot(1951:2110,rep(0,160),xlim=c(1965,2090),ylim=yl,xaxt="n",type="l",lwd=k,lty=3,xlab="",ylab="Avvik (m/s)",col="grey")
abline(h=seq(-1,1,0.05),col="grey",lty=3,lwd=k)
