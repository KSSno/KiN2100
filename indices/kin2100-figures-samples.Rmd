...
We need to read in observations (historical/"observed" temperature for Norway) and corresponding statistics from empirical-statistical downscaling (ESD). The obsefvations were downloaded as CSV-file from <https://klimaservicesenter.no/kss/vrdata/regionv> and it's not obvious what Google-doc contains what. My guess is that the following file contains the country temperature regord for all of Norway, but there is no guarantee for this being correct:
